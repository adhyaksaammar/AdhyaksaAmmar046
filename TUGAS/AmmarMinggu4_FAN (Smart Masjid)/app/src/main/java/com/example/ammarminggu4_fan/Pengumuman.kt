...
class Pengumuman : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://smartmasjid.000webhostapp.com/cobarepo-master/contoh_pengumuman_json.php")
    ...
    {
        AndroidNetworking.post("https://smartmasjid.000webhostapp.com/cobarepo-master/proses_pengumuman.php")
