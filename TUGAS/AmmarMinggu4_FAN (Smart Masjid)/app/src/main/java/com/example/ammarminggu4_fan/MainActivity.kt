...
class MainActivity : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://smartmasjid.000webhostapp.com/cobarepo-master/contoh_jadwal_json.php")
    ...
    {
        AndroidNetworking.post("https://smartmasjid.000webhostapp.com/cobarepo-master/proses_jadwal.php")
