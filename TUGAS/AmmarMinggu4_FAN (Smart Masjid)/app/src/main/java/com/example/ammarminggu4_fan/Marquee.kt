...
class Marquee : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://smartmasjid.000webhostapp.com/cobarepo-master/contoh_marquee_json.php")
    ...
    {
        AndroidNetworking.post("https://smartmasjid.000webhostapp.com/cobarepo-master/proses_marquee.php")
