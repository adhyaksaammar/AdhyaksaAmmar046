...
class IdentitasMasjid : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://smartmasjid.000webhostapp.com/cobarepo-master/contoh_identitas_json.php")
    ...
    {
        AndroidNetworking.post("https://smartmasjid.000webhostapp.com/cobarepo-master/proses_identitas.php")
