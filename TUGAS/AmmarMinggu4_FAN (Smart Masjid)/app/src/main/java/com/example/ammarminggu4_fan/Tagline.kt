...
class Tagline : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://smartmasjid.000webhostapp.com/cobarepo-master/contoh_tagline_json.php")
    ...
    {
        AndroidNetworking.post("https://smartmasjid.000webhostapp.com/cobarepo-master/proses_tagline.php")
